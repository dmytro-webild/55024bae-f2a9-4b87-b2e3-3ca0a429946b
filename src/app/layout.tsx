...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Paws Haven - Pet Adoption & Animal Shelter",    description: "Give a pet a forever home. Browse our available animals and start your adoption journey today.",    url: "https://pawshaven.org",    siteName: "Paws Haven",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/woman-playing-with-rescue-dogs-shelter_23-2148682984.jpg",        alt: "Paws Haven Animal Shelter"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Paws Haven - Pet Adoption & Animal Shelter",    description: "Give a pet a forever home. Browse our available animals and start your adoption journey today.",    images: ["http://img.b2bpic.net/free-photo/woman-playing-with-rescue-dogs-shelter_23-2148682984.jpg"],
  },
};
